...
for pdf in "${PDF_FILES[@]}"; do
  ...
  prompt="Nutze die Skills import-scanned-belege und pdf. Bearbeite genau diese Datei: ${rel_pdf}. Lies und interpretiere den Beleg. Erzeuge/aktualisiere exakt diese JSON-Datei: ${rel_json}. Fuehre danach den Import aus mit: python3 tools/scanned-beleg-inserter/main.py import --beleg-file ${json} --strict --db ${DB_PATH}."
